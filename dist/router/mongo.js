...
const _mongodb = express_1.Router();
//OBTIENE TODOS LOS HEROES
_mongodb.get('/heroes_mongodb', (req, res) => {
    //RECIBO DESDE DONDE PAGINAR
    var desde = req.query.desde || 0;
    desde = Number(desde);
    //ESTA FUNCION DEVUELVE TODOS LOS DATOS PAGINADOS
    mongodb_1.default.obtenerTodos(heroe_1.default, desde, (err, datos) => {
        //SI EXISTE UN ERROR
        if (err) {
            res.status(400).json({
                error: true,
